    ...
    <div class="zona1">
        <div class="registro">
            <div class="Login-div">
                ...
                <div class="title">Sesión Yolo's</div>
                <div class="fields">
                    <form action="" method="post">
                        ...
                        <button type="submit" name="login" id="sign_in" class="signin-button">Iniciar sesiòn</button>
                    </form>
                </div>
                <div class="link">
                    <a href="#">Olvidaste tu contraseña?</a> o <a href="registro.php">Registrarse</a>
                </div>
            </div>
        </div>
    </div>
